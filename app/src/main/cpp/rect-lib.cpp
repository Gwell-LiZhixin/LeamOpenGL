...
Renderer::Renderer() : mLastFrameNs(0), mProgram(0), mVBState(0) {
...
void Renderer::render() {
    ...
    glClearColor(0.2f, -.2f, 0.3f, 1.0f);
...
float *Renderer::mapTransformBuf() {
    ...
    return (float *) glMapBufferRange(GL_ARRAY_BUFFER, 0, 4 * sizeof(float),
...
Java_com_example_leamopengl_model_RectLib_00024Companion_init(JNIEnv *env, jobject thiz) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
...
Java_com_example_leamopengl_model_RectLib_00024Companion_resize(JNIEnv *env, jobject thiz, jint width,
                                                 jint height) {
    if (g_renderer) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leamopengl_model_RectLib_00024Companion_step(JNIEnv *env, jobject thiz) {
    if (g_renderer) {
        g_renderer->render();
    }
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leamopengl_model_RectLib_00024Companion_destroy(JNIEnv *env, jobject thiz) {
    delete g_renderer;
    g_renderer = NULL;
}
