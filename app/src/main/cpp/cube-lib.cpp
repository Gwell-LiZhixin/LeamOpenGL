//
// Created by lizhixin on 2021/12/8.
//
...
bool init() {
    cube_program = createProgram(VERTEX_SHADER, FRAGMENT_SHADER);
    if (!cube_program)
        return false;
    ...
    glBindBuffer(GL_ARRAY_BUFFER, colorVBO);
    glVertexAttribPointer(COLOR_IND, 4, GL_FLOAT, GL_FALSE, 0, (const void *) NULL);
    ...
    glBindBuffer(GL_ARRAY_BUFFER, positionVBO);
    glVertexAttribPointer(POSITION_IND, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat),
                          (const void *) NULL);
...
Java_com_example_leamopengl_model_CubeLib_00024Companion_init(JNIEnv *env, jobject thiz) {
...
Java_com_example_leamopengl_model_CubeLib_00024Companion_resize(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leamopengl_model_CubeLib_00024Companion_step(JNIEnv *env, jobject thiz) {
    timespec now;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leamopengl_model_CubeLib_00024Companion_destroy(JNIEnv *env, jobject thiz) {
